...
#cp .\src\build.json .\src\Cortside.AmqpTools.WebApi\build.json -force
...
Invoke-Exe -cmd dotnet -args $args
#$args = "publish $PSScriptRoot\src\Cortside.AmqpTools.WebApi\Cortside.AmqpTools.WebApi.csproj --no-restore /p:Version=$BuildNumber"
#Invoke-Exe -cmd dotnet -args $args
